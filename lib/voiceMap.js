...
export const voiceMap = {
  // English voices
  'Dave': 'REPLACE_WITH_DAVE_VOICE_ID',
  'Chisom': 'REPLACE_WITH_CHISOM_VOICE_ID', 
  'Alex': 'REPLACE_WITH_ALEX_VOICE_ID',
  
  // Additional voices (add more as needed)
  'Sarah': 'REPLACE_WITH_SARAH_VOICE_ID',
  'Michael': 'REPLACE_WITH_MICHAEL_VOICE_ID',
  'Emma': 'REPLACE_WITH_EMMA_VOICE_ID',
};
